                                ...
                                <a href="#" className="link">
                                    <span className="link-arrow-span">
                                        <svg className='link-arrow' width="25" height="25" viewBox="0 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M9.02344 18.1202L15.0234 12.1202L9.02344 6.12024" stroke="#453D43" strokeLinecap="round" strokeLinejoin="round"/>
                                        </svg>
                                    </span>
            ...
            <div className="copyright-footer">
                <div className="social-links-sec">
                    <div className="social-link-wrapper">
                        <a href="#" className="social-link">
                            <svg width="26" height="26" viewBox="0 0 26 26" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <g clipPath="url(#clip0_9970_1663)">
                    ...
                    <div className="social-link-wrapper">
                        <a href="#" className="social-link">
                            <svg width="26" height="26" viewBox="0 0 26 26" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <g clipPath="url(#clip0_9970_1667)">
                    ...
                    <div className="social-link-wrapper">
                        <a href="#" className="social-link">
                            <svg width="28" height="20" viewBox="0 0 28 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path fillRule="evenodd" clipRule="evenodd" d="M26.0201 1.5585C26.439 1.98011 26.7398 2.50436 26.8925 3.07876C27.457 5.19888 27.457 9.62013 27.457 9.62013C27.457 9.62013 27.457 14.0414 26.8925 16.1615C26.7398 16.7359 26.439 17.2601 26.0201 17.6818C25.6012 18.1034 25.0789 18.4076 24.5054 18.5639C22.3945 19.1315 13.957 19.1315 13.957 19.1315C13.957 19.1315 5.51953 19.1315 3.40862 18.5639C2.8352 18.4076 2.3129 18.1034 1.89398 17.6818C1.47506 17.2601 1.17422 16.7359 1.02158 16.1615C0.457031 14.0414 0.457031 9.62013 0.457031 9.62013C0.457031 9.62013 0.457031 5.19888 1.02158 3.07876C1.17422 2.50436 1.47506 1.98011 1.89398 1.5585C2.3129 1.13689 2.8352 0.832703 3.40862 0.676379C5.51953 0.108765 13.957 0.108765 13.957 0.108765C13.957 0.108765 22.3945 0.108765 24.5054 0.676379C25.0789 0.832703 25.6012 1.13689 26.0201 1.5585ZM18.2525 9.62016L11.1957 5.60545V13.6349L18.2525 9.62016Z" fill="#453D43"/>
                            </svg>
                        </a>
                    </div>
                    <div className="social-link-wrapper">
